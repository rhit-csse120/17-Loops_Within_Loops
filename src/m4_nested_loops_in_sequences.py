...
def run_test_sum_numbers():
    ...
    print_expected_result_of_test(
        [[(3, 1, 4), (10, 10), [1, 2, 3, 4]]], expected, test_results, format_string
    )
    actual = sum_numbers([(3, 1, 4), (10, 10), [1, 2, 3, 4]])
    print_actual_result_of_test(expected, actual, test_results)

    # Test 2:
    expected = 5
    print_expected_result_of_test(
        [([], [5], [])], expected, test_results, format_string
    )
    ...
    actual = sum_numbers(
        [(5, 0, 4), (10,), (), (8, 3, 2, 10, 10), (3, 5), (1, 2, 3, 4, 5, 6, 7, 8, 9)]
    )
    print_actual_result_of_test(expected, actual, test_results)
...
def run_test_multiply_by_c():
    ...
    print_expected_result_of_test(
        [c, seq_of_lists], expected, test_results, format_string
    )
    actual = multiply_by_c(c, seq_of_lists)
    ...
    print_expected_result_of_test([c, seq_of_lists], None, test_results, format_string)
    ...
    expected = [
        [],
        [100],
        [2000, 200, 3000, 400, 10000, 800, 200, 200, 200],
        [],
        [30000],
        [500, 500],
        [],
